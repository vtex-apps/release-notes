...
- **React app dependencies** - The wise Toolbelt will now update an App React's dependencies located in the app's `package.json` file to keep them in line with Render's dependencies list. Find out more details on this improvement [here]((https://vtex.io/docs/releases/2020-feb/react-app-dependencies)!
